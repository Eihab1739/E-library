    ...
    <div class="container pt-5">
        ...
        <div class="card p-2 shadow-sm bg-secondary mt-4">
            <form action="/results" method="GET">
                @csrf
                <div class="input-group"><input class="form-control d-inline-block" type="search" name="examsearch" placeholder="{{__('web.search')}}"> <a href="" class="btn btn-primary text-white mx-2"><i class="ion-md-search "></i></a></div>
            </form>
        </div>
