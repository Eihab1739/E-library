    ...
    <div class="row justify-content-center pt-md-4">        
        <div class="col-sm-12 col-md-8">
            <div class="card my-5 shadow-sm border-0 text-white bg-secondary">
                <div class="card-header bg-primary"><i class="ion-md-person-add"></i> {{ __('web.register') }}</div>
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group">
                            <label for="name" class=" text-md-right"><i class="ion-md-text"></i> {{ __('web.name') }}</label>
                        ...
                        <div class="form-group">
                            <label for="email" class=" text-md-right"><i class="ion-md-mail"></i> {{ __('web.email') }}</label>
                        ...
                        <div class="form-group">
                            <label for="password" class=" text-md-right"><i class="ion-md-lock"></i> {{ __('web.password') }}</label>
                        ...
                        <div class="form-group">
                            <label for="password-confirm" class=" text-md-right"><i class="ion-md-lock"></i> {{ __('web.cpassword') }}</label>
