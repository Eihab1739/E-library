        ...
        <nav class="navbar navbar-expand-md fixed-top navbar-light bg-white shadow-sm" style="z-index: 2">
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <!-- Left Side Of Navbar -->
                    <ul class="navbar-nav mx-md-5 ml-auto">
                        <li class="nav-item"><a class="nav-link" href="/">
                            <i class="ion-md-home"></i> {{__('Home')}}
                        </a></li>
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" type="button" id="browse-dropdown" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <i class="ion-md-list"></i> {{__('Browse')}}
                            </a>
                            <div class="dropdown-menu" aria-labelledby="browse-dropdown">
                                <a class="dropdown-item" href="/books"><i class="ion-md-book"></i> {{__('Books')}}</a>
                                <a class="dropdown-item" href="/exams"><i class="ion-md-paper"></i> {{__('Exams')}}</a>
                                <a class="dropdown-item" href="/projects"><i class="ion-md-school"></i> {{__('Projects')}}</a>
                            </div>
                        </li>
                    </ul>
