...
|
*/
Route::get('/reserve-notify/{id}', 'reserveBookController@notification')->name('notification');
Route::get('/borrow-notify/{id}', 'borrowBookController@borrowNotification')->name('notification');
...
Route::group(
    ...
    ], function()
    {
        ...
        Route::group(['prefix' => 'admin','middleware'=>'roles','roles'=>'admins'], function ()
        {
            ...
            Route::get('admin/exams','examsController@index')->name('exams');
        ...
        Route::post('/request','booksController@requestBook')->name('requestBook');
        Route::get('/display','booksController@viewRequest')->name('display');
        Route::Delete('/delete/{id}','booksController@deleteRequest')->name('delete');
        ...
        // });
        Route::get('/books','booksController@view')->name('browse-book');

        // Route::get('/projects', function () {
        //     $projects=Project::all();
        //     return view('browse-projects' , compact('projects'));
        // });
        Route::get('/projects','projectController@view')->name('browse-project');
        ...
        // });
        Route::get('/exams','examsController@view')->name('browse-exam');
